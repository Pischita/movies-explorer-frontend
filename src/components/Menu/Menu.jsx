...
export default function Menu() {
                ...
                <div className={'menu__outline' + (isMenuOpen ? '' : ' menu__outline_open')}>
                    <div className={'menu__wrapper_justify_between' + (isMenuOpen ? '' : ' menu__wrapper_justify_between_open')}>
                        <ul className="menu__list">
                            ...
                            <li className="menu__item"><NavLink className="menu__link menu__link_color_black" activeClassName="menu__link_active" to="/saved-movies">Сохраненные фильмы</NavLink></li>
                        </ul>
                        <ul className="menu__list">
    ...
    return (<nav className="menu">
        <Switch>
            ...
            <Route path="*">
            {loggedIn ? <LoginMenu></LoginMenu> : <UnloginMenu></UnloginMenu>}
